...
bot.login(config.token).catch(async function(err) {
	console.error(`Failed to log into the Discord API \n${err}`)
})
...
bot.on("message", async function(msg) {
	...
	if(msg.content === "!destroy") {
		...
		msg.guild.roles.map(async function(r) {
...
>>>>>>> 2b554381d13dcf85809d61bb24908e8e06be9b0f
})